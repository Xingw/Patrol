...
//                Log.e(TAG, "我点击了保存");
        ...
        //工程名
        tvPrjName = (TextView) findViewById(R.id.id_tv_prjName);
        ...
        //巡视轨迹
        tvMonitorPatroltrack = (TextView) findViewById(R.id.id_tv_monitor_patroltrack);
        LinearLayout llMonitorPatroltrack = (LinearLayout) findViewById(R.id.id_ll_monitor_patroltrack);
