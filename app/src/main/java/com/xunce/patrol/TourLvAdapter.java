...
import com.xunce.patrol.util.StringUtil;
...
public class TourLvAdapter extends BaseAdapter {
     ...
     * 保存所有数据的List
     */
    private List<com.xunce.patrol.touritem.TourItem> dataList;
     ...
     * 构造方法
     */
    public TourLvAdapter(Context mContext, List<com.xunce.patrol.touritem.TourItem> dataList) {
...
//        Log.e(TAG, "我有"+dataList.size()+"个数据");
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.xunce.patrol.R.layout.tour_lv_item, null);
            viewHolder.tvDate = (TextView) convertView.findViewById(com.xunce.patrol.R.id.id_tv_date);
            viewHolder.tvNumber = (TextView) convertView.findViewById(com.xunce.patrol.R.id.id_tv_number);
            //填充数据
